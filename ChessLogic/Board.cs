    ...
    public class Board
    {
        ...
        public bool InsufficientMaterial() 
        {
            ...
            return IsKingVKing(counting) || IsKingBishopVKing(counting) ||
                IsKingKnightKVking(counting) || IsKingBishopVKingBishop(counting);
        }
        ...
        private static bool IsKingKnightKVking(Counting counting) 
        {
        ...
        private bool HasPawnInPosition(Player player, Position[] pawnPositions, Position skiPos) 
        {
            foreach (Position pos in pawnPositions.Where(IsInside)) 
            {
                ...
                EnPassant move = new EnPassant(pos, skiPos);
        ...
        public bool CanCaptureEnPassant(Player player) 
        {
            ...
            Position[] pawPositions = player switch
            {
            ...
            return HasPawnInPosition(player, pawPositions, skipPos); 
        }
